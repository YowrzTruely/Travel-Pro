...
export function RoadExpenseForm({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md rounded-t-xl bg-card p-5 shadow-2xl sm:rounded-xl"
        dir="rtl"
      >
        {/* Header */}
        ...
        <div className="mb-4 space-y-3">
          ...
          <div>
            ...
            />
            <button
              className="flex min-h-11 w-full items-center justify-center gap-2 rounded-lg border border-border border-dashed px-3 py-2 text-[14px] text-muted-foreground transition-colors hover:border-primary hover:text-primary disabled:opacity-50"
              disabled={uploading}
        ...
        {/* Submit */}
        <button
          className="mb-4 flex min-h-11 w-full items-center justify-center gap-2 rounded-xl bg-primary px-4 py-2.5 text-[14px] text-white transition-colors hover:bg-primary-hover disabled:cursor-not-allowed disabled:opacity-50"
        ...
        {expenses && expenses.length > 0 && (
          <div className="border-border border-t pt-3">
            ...
            <div className="max-h-40 space-y-1 overflow-y-auto">
              {expenses.map((exp) => (
                <div
                  className="flex items-center justify-between rounded-lg bg-surface px-3 py-2 text-[13px]"
                  key={exp.id}
                >
                  <div className="flex items-center gap-2">
            ...
            <div className="mt-2 flex justify-between border-border border-t pt-2 text-[14px]">
