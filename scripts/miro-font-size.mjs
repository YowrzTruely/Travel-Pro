...
(async () => {
  ...
  await page.screenshot({
    path: "C:/Users/User/OneDrive/Desktop/TravelPro/Travelprov1/scripts/miro-toolbar.png",
  });
  ...
  const fontInfo = await page.evaluate(() => {
    ...
    document
      .querySelectorAll(
        '[class*="toolbar"] *, [class*="Toolbar"] *, [class*="panel"] *, [data-testid]'
      )
      .forEach((el) => {
    ...
    document
      .querySelectorAll(
        '[data-testid*="font"], [data-testid*="size"], [aria-label*="font"], [aria-label*="Font"], [aria-label*="size"], [aria-label*="Size"]'
      )
      .forEach((el) => {
        results.push({
    ...
    document
      .querySelectorAll(
        'input[type="text"], input[type="number"], input:not([type]), [contenteditable="true"]'
      )
      .forEach((el) => {
  ...
  console.log(
    "\nFont size selector:",
    fontSizeSelector || "Not found - will try coordinate-based approach"
  );
